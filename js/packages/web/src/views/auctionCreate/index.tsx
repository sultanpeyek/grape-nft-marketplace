  ...
  return (
    <>
      <Row className="call-to-action">
        <h2>List an item</h2>
        <p>
          First time listing on GRAPE NFT Marketplace? <a>Read our sellers' guide.</a>
        </p>
      </Row>
  ...
  return (
    ...
    >
      ...
      <div className="waiting-title">
        Your creation is being listed with GRAPE NFT Marketplace...
      </div>
...
const Congrats = (props: {
  ...
  const newTweetURL = () => {
    const params = {
      text: "I've created a new NFT auction on GRAPE NFT Marketplace, check it out!",
      url: `${
